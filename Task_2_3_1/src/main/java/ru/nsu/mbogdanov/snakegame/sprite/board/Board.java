 ...
 * It also implements the Sprite interface and contains methods for checking intersection with other sprites,
...
public abstract class Board implements Sprite {
     ...
     *
     * @param x - x coordinate of the board cell position
     * @param y - y coordinate of the board cell position
     */
    @Override
