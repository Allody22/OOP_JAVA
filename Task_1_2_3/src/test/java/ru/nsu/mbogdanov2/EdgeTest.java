...
public class EdgeTest {
    ...
    public void getSecondVertexNameTests() {
        ...
        Assertions.assertEquals(expectedSecondVertex.getName(),
                expectedGraph.getEdge("one", "two", 33).getV2().getName());
        Assertions.assertEquals(expectedSecondVertex.getName(),
                expectedGraph.getEdge("one", "two", 66).getV2().getName());
    }
    ...
    public void getFirstVertexNameTests() {
        ...
        Assertions.assertEquals(expectedSecondVertex.getName(),
                expectedGraph.getEdge("one", "two", 33).getV1().getName());
        Assertions.assertEquals(expectedSecondVertex.getName(),
                expectedGraph.getEdge("one", "two", 66).getV1().getName());
    }
}
