...
public class Stack<T> { 
  ...
  /**
   * Stack itself.
   * with array stack to contain elements
   ...
   * with error out of bounds handling that fails the test
   */
  ...
  /**
   * Override of toString method in order for the checks
   * to work correctly with generics arrays, to compare them
   */
